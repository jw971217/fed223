...
$(()=>{
    ...
    /******************************************** 
        ...
        -> id가 'email2'가 아니고 class가 'search'가 아닌
        // type이 'text'인 입력 요소 input

        >>> 제이쿼리 선택표현법: 
        input[type=text][id!=email2][class!=search]
        >>> 대괄호는 속성선택자, !=같지 않다(제이쿼리 전용)
    ...
    ********************************************/
        ...
        .blur(function(){
            ...
            // 정규식: 슬래쉬(/) 사이에 표현함, \s 스페이스 문자
            // g는 모두 찾으라는 global(전역) 플래그문자임
            // flag는 깃발이라는 영단어. 즉 표시자문법
            ...
            // cv는 current value 즉, 혀냊값이라는 뜻
            console.log('블러발생',cid,'/',cv);

            // "이름"일 경우 앞뒤 공백만 제거함: trim()
