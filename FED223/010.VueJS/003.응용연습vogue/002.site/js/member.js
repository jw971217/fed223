    ...
    ********************************************/
        ...
        .blur(function(){
            ...
            ************************************/
            ...
            if(cv === ""){
                ...
                // .msg 박스는 input요소의 형제요소임
                // siblings(요소) - 다른형제요소 중 특정요소선택
                // siblings() 아무값도 안 쓰면 다른형제 요소 모두 선택
            ...
            ************************************/
                ...
                if(!vReg(cv,cid)){ //불통과일 경우!
                    // !(NOT연산자) -> false 일 때 if 문으로 들어옴!
                    // 메시지 띄우기
                    $(this).siblings('.msg')
                    .text('영문자로 시작하는 6~20 글자 영문자/숫자')
                    .removeClass('on')//녹색글자 지움
                }///// if : 아이디검사 불통과
        ...
        ****************************************/
        ...
        /********************************************** 
            ...
            3. keydown : 키가 눌려져서 내려가있을 때
            -> 과연 글자가 입력되는 순간은 어떤 키보드 이벤트가 적용되는 걸까?
            ->>> keyup!!
       ...
       $('#email1, #email2').on("keyup",function(){
        ...
        // 조건: email인가? 즉 앞주소인가?
        // 맞으면 선택박스 값을 읽어가고 아니면 직접입력창을 읽어라!
        ...
        ***************************************************************/
        ...
        // action 속성에 지정된 페이지로 현재 페이지 값을 가지고
        ...
        $('#btnj').click(e=>{
            ...
            if(pass){ ////////// 통과시 ////////////////   
                ...
                /* 
                    회원가입 후 이전페이지로 못가도록
                    location.replace(주소)를 사용하여 페이지 캐쉬를 삭제하도록 하여
                    좀 더 안전한 보안을 유지한다.
                */
